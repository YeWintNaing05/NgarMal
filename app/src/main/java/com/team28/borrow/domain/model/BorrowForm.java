...
@AutoValue
public abstract class BorrowForm {



    public static BorrowForm create(String name, String item_name, String item_brand, String img, String state, String item_id, String post_user_id, String user_id, String address, String phone, String start_borrow_date, String number_of_borrow_day, String fee, String date) {
        return builder()
                .img(img)
                .item_name(item_name)
    ...
    public static BorrowForm.Builder builder() {
        return new AutoValue_BorrowForm.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract BorrowForm build();
