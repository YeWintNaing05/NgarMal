...
public class GetPostItemByCategory extends UseCase<GetPostItemByCategory.Action, List<PostItem>> {
    ...
    @Inject
    public GetPostItemByCategory(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, PostItemRepository mPostItemRepository) {
        super(threadExecutor, postExecutionThread);
        this.mPostItemRepository = mPostItemRepository;
    }

    @Override
    public Observable<List<PostItem>> execute(GetPostItemByCategory.Action action) {
        return mPostItemRepository.getItemsByCategory(action.category).toObservable();
    }
